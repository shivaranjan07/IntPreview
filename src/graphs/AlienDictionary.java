...
class AlienDictionary {
    public static String findOrder(String[] words) {
        ...
        for (int i = 0; i < words.length - 1; i++) {
            ...
            /**
             * One edge case we need to be careful of is where a word is followed by its own prefix.
             * In these cases, it is impossible to come up with a valid ordering and so we should return "".
